...
void man(char *name)
{
    ...
    else if(strcmp(name,"write")==0)
    {
        ...
        printf("Usage :write File_name\nAfter this write the data that you want to write\n");
    }
    else if(strcmp(name,"ls")==0)
    {
        printf("Description : Used to display information of all files\n");
        printf("Usage :ls\n");
    }
    ...
    {
        printf("Description : Used to change file offfset\n");
...
void DisplayHelp()
{
    ...
    printf("closeall:To close all the operand File.\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        count=sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);    // tokaniztion
        ...
        if(count==1)
        {
            ...
            {
                printf("Terminting the Marvellous Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret>=0)
                       printf("File is successfully created with file descpritor: %d\n",ret);
                if(ret==-1)
                       printf("ERROR:Incorrect parameters\n");     
                if(ret==-2)
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret>=0)
                        printf("File is successfully opened with file descpritor: %d\n",ret);
                if(ret==-1)
                        printf("ERROR:Incorrect parameters\n");     
                if(ret==-2)
